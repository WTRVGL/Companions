...
namespace Companions.API.Migrations
{
    ...
    [Migration("20221228075520_LocationsAndPlacesAdded")]
    partial class LocationsAndPlacesAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Companions.Domain.Location", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Companions.Domain.Place", b =>
                {
                    b.HasOne("Companions.Domain.Location", "Location")
                        .WithMany()
