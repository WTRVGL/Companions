...
namespace Companions.API.Controllers
{
    ...
    public class ActivityController : ControllerBase
    {
        ...
        public ActivityController(IBuddyService buddyService, IMapper mapper)
        {
        ...
        [Authorize]
        public ActionResult<ActivityDTO> CreateActivity(ActivityDTO activityDTO, string buddyId)
        {
            ...
            var createdActivity = _activityService.AddActivity(activity);
